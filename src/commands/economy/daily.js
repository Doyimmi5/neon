...
module.exports = {
  name: "daily",
  description: "receber um bônus diário",
  category: "ECONOMY",
...
async function daily(user) {
  ...
  if (userDb.daily.timestamp) {
    ...
    if (difference < 24) {
      ...
      return `Você pode usar este comando novamente em \`${getRemainingTime(nextUsage)}\``;
    }
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      `Você recebeu ${ECONOMY.DAILY_COINS}${ECONOMY.CURRENCY} como sua recompensa diária\n` +
